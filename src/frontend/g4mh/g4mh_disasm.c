                   ...
                   unsigned len)
{
    ...
    case 0x00:
        ...
        break;
    case 0x01:
        n = snprintf(buf, buflen, "not %s, %s", a, b);
        break;
    case 0x02:
    ...
    case 0x07:
        ...
        break;
    case 0x08:
        n = snprintf(buf, buflen, "or %s, %s", a, b);
        break;
    case 0x09:
        n = snprintf(buf, buflen, "xor %s, %s", a, b);
        break;
    case 0x0A:
        n = snprintf(buf, buflen, "and %s, %s", a, b);
        break;
    case 0x0B:
        n = snprintf(buf, buflen, "tst %s, %s", a, b);
        break;
    case 0x0C:
        n = snprintf(buf, buflen, "subr %s, %s", a, b);
        break;
    case 0x0D:
        n = snprintf(buf, buflen, "sub %s, %s", a, b);
        break;
    case 0x0E:
        n = snprintf(buf, buflen, "add %s, %s", a, b);
        break;
    case 0x0F:
        n = snprintf(buf, buflen, "cmp %s, %s", a, b);
        break;

    case 0x10:
        n = snprintf(buf, buflen, "mov %d, %s", g4mh_imm5(w0), b);
        break;
    case 0x11:
        n = snprintf(buf, buflen, "satadd %d, %s", g4mh_imm5(w0), b);
        break;
    case 0x12:
        n = snprintf(buf, buflen, "add %d, %s", g4mh_imm5(w0), b);
        break;
    case 0x13:
        n = snprintf(buf, buflen, "cmp %d, %s", g4mh_imm5(w0), b);
        break;
    case 0x14:
        n = snprintf(buf, buflen, "shr %u, %s", (unsigned)(w0 & 0x1Fu), b);
        break;
    case 0x15:
        n = snprintf(buf, buflen, "sar %u, %s", (unsigned)(w0 & 0x1Fu), b);
        break;
    case 0x16:
        n = snprintf(buf, buflen, "shl %u, %s", (unsigned)(w0 & 0x1Fu), b);
        break;
    case 0x17:
        /* reg2 == 0 is JR/JARL disp32, not a multiply. */
        n = (r2 == 0u) ? snprintf(buf, buflen, "jr 0x%08x",
                                  pc + (((w2 << 16) | (w1 & 0xFFFEu))))
                       : snprintf(buf, buflen, "mulh %d, %s", g4mh_imm5(w0), b);
        break;

    case 0x30:
        n = snprintf(buf, buflen, "addi %d, %s, %s", (int)emu_sext(w1, 16), a,
                     b);
        break;
    case 0x31:
        n = (r2 == 0u) ? snprintf(buf, buflen, "mov 0x%04x%04x, %s",
                                  (unsigned)w2, (unsigned)w1, a)
                       : snprintf(buf, buflen, "movea %d, %s, %s",
                                  (int)emu_sext(w1, 16), a, b);
        break;
    case 0x32:
        n = snprintf(buf, buflen, "movhi 0x%04x, %s, %s", (unsigned)w1, a, b);
        break;
    case 0x33:
        n = snprintf(buf, buflen, "satsubi %d, %s, %s", (int)emu_sext(w1, 16),
                     a, b);
        break;
    case 0x34:
        n = snprintf(buf, buflen, "ori 0x%04x, %s, %s", (unsigned)w1, a, b);
        break;
    case 0x35:
        n = snprintf(buf, buflen, "xori 0x%04x, %s, %s", (unsigned)w1, a, b);
        break;
    case 0x36:
        n = snprintf(buf, buflen, "andi 0x%04x, %s, %s", (unsigned)w1, a, b);
        break;
    case 0x37:
        /*
         ...
         */
        n = (r2 != 0u) ? snprintf(buf, buflen, "mulhi %d, %s, %s",
                                  (int)emu_sext(w1, 16), a, b)
            : ((w1 & 1u) != 0u)
    ...
    case 0x38:
        n = snprintf(buf, buflen, "ld.b %d[%s], %s", (int)emu_sext(w1, 16), a,
                     b);
        break;
    case 0x39:
        n = snprintf(buf, buflen, "ld.%c %d[%s], %s", (w1 & 1u) ? 'w' : 'h',
                     (int)emu_sext(w1 & 0xFFFEu, 16), a, b);
        break;
    case 0x3A:
        n = snprintf(buf, buflen, "st.b %s, %d[%s]", b, (int)emu_sext(w1, 16),
                     a);
        break;
    case 0x3B:
        n = snprintf(buf, buflen, "st.%c %s, %d[%s]", (w1 & 1u) ? 'w' : 'h', b,
    ...
    case 0x3D:
        ...
        if ((w1 & 1u) != 0u) {
            if (r2 != 0u) {
                ...
                switch (ff) {
                case 0u:
                    snprintf(ep, sizeof(ep), "sp");
                    break;
                case 1u:
                    snprintf(ep, sizeof(ep), "0x%08x",
                             (unsigned)(uint32_t)emu_sext(w2, 16));
                    break;
                case 2u:
                    snprintf(ep, sizeof(ep), "0x%04x0000", (unsigned)w2);
                    break;
                default:
                    snprintf(ep, sizeof(ep), "0x%04x%04x", (unsigned)w3,
                             (unsigned)w2);
                    break;
                }
                ...
                if (mn == NULL) {
                    ...
                    n = snprintf(buf, buflen, "%s %s, %d[%s]", mn,
                                 g4mh_reg_name((w1 >> 11) & 0x1Fu), disp, a);
                } else {
                    n = snprintf(buf, buflen, "%s %d[%s], %s", mn, disp, a,
    ...
    case 0x3F: {
        ...
        case 0x000:
            ...
            break;
        case 0x020:
            n = (srn != NULL) ? snprintf(buf, buflen, "ldsr %s, %s", b, srn)
                              : snprintf(buf, buflen, "ldsr %s, %u, %u", b,
                                         (unsigned)r1, (unsigned)sel);
            break;
        case 0x040:
            n = (srn != NULL) ? snprintf(buf, buflen, "stsr %s, %s", srn, b)
                              : snprintf(buf, buflen, "stsr %u, %s, %u",
                                         (unsigned)r1, b, (unsigned)sel);
            break;
        case 0x080:
            n = snprintf(buf, buflen, "shr %s, %s", a, b);
            break;
        case 0x0A0:
            n = snprintf(buf, buflen, "sar %s, %s", a, b);
            break;
        case 0x0C0:
            n = snprintf(buf, buflen, "shl %s, %s", a, b);
            break;
        case 0x100:
            n = snprintf(buf, buflen, "trap %u", (unsigned)r1);
            break;
        case 0x120:
            n = snprintf(buf, buflen, "halt");
            break;
        case 0x140:
            n = snprintf(buf, buflen, "reti");
            break;
        case 0x160:
            n = snprintf(buf, buflen, (w0 & 0x8000u) ? "ei" : "di");
            break;
        /*
         ...
         */
        case 0x164:
            n = snprintf(buf, buflen, "stm.mp %u-%u, [%s]", (unsigned)r2,
                         (unsigned)sel, a);
            break;
        case 0x166:
            n = snprintf(buf, buflen, "ldm.mp [%s], %u-%u", a, (unsigned)r2,
                         (unsigned)sel);
            break;
        ...
        case 0x37A: {
            ...
            const char *const sz =
                (sub < 0x374u) ? "b" : ((sub < 0x378u) ? "h" : "w");
            const char *const u =
                (sub >= 0x378u || store || (r2 & 1u) == 0u) ? "" : "u";
            const char *const rn = g4mh_reg_name(sel);

            if (mode == 0u) {
                n = store ? snprintf(buf, buflen, "stc.%s %s, [%s]", sz, rn, a)
                          : snprintf(buf, buflen, "ldl.%s%s [%s], %s", sz,
                                     (sub >= 0x378u) ? "" : "u", a, rn);
            } else if (mode <= 2u) {
                const char step = (mode == 1u) ? '+' : '-';
                n = store ? snprintf(buf, buflen, "st.%s %s, [%s]%c", sz, rn, a,
                                     step)
                          : snprintf(buf, buflen, "ld.%s%s [%s]%c, %s", sz, u,
                                     a, step, rn);
            } else {
                n = snprintf(buf, buflen, ".short 0x%04x, 0x%04x", (unsigned)w0,
                             (unsigned)w1);
            }
            break;
        }
        ...
        default:
            ...
            case 0x220:
                n = snprintf(buf, buflen, "mul%s %s, %s, %s",
                             (sub & 2u) ? "u" : "", a, b, g4mh_reg_name(sel));
                break;
            case 0x2C0:
    ...
    default: {
        ...
        if (op4 == 0x0Bu) {
            const uint32_t d =
                (((w0 >> 11) & 0x1Fu) << 4) | (((w0 >> 4) & 0x7u) << 1);
            n = snprintf(buf, buflen, "b%s 0x%08x", g4mh_cond_name(w0 & 0xFu),
