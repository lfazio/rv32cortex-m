...
/*
 * platform.c - what the stm32f446 owes the shared runner.
 *
...
const char *const board_core_name = "Cortex-M4";
 ...
 * with -- see board_irq_unmask, reached through the frontend's unmask hook.
 *
