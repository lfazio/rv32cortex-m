...
# layer for the register definitions, startup file and system_stm32f4xx.c,
# and the STM32Cube HAL for clock, GPIO and UART bring-up.
#
# ST publishes these as three standalone repositories, which is what the
# Cube "modular" distribution is meant for. They are fetched at configure
# time; point STM32CUBE_LOCAL_DIR at a directory holding checkouts named
# cmsis_core / cmsis_device_f4 / stm32f4xx_hal_driver to build offline.
...
_cube_declare(cmsis_device_f4     cmsis_device_f4     "${STM32CUBE_DEVICE_F4_TAG}")
_cube_declare(stm32f4xx_hal_driver stm32f4xx_hal_driver "${STM32CUBE_HAL_F4_TAG}")

# Populate only; none of these ship a usable CMakeLists, so the targets are
# defined here instead of via add_subdirectory.
FetchContent_MakeAvailable(cmsis_core cmsis_device_f4 stm32f4xx_hal_driver)
...
set(STM32_HAL_DIR    "${stm32f4xx_hal_driver_SOURCE_DIR}")
