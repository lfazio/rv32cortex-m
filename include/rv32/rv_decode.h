...
static EMU_ALWAYS_INLINE int32_t rv_imm_s(uint32_t i)
{
...
static EMU_ALWAYS_INLINE uint32_t rv_imm_u(uint32_t i)
{
...
static EMU_ALWAYS_INLINE bool rv_is_32bit(uint16_t parcel)
{
...
static EMU_ALWAYS_INLINE unsigned rv_insn_len(uint16_t parcel)
{
