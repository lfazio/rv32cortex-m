...
#endif
#if RV_EXT_S
#define MSTATUS_WMASK_S                                                        \
    (MSTATUS_SIE | MSTATUS_SPIE | MSTATUS_SPP | MSTATUS_TW | MSTATUS_TSR |     \
     MSTATUS_WMASK_VM)
#else
...
#define MSTATUS_WMASK                                                          \
    (MSTATUS_MIE | MSTATUS_MPIE | MSTATUS_MPP_MASK | MSTATUS_WMASK_F |         \
     MSTATUS_WMASK_U | MSTATUS_WMASK_S)
